...
/** @hidden */
declare function readKeyFile(filename: string): Promise<[string, KeyPair]>;
/**
 ...
 * ```
 */
declare class UnencryptedFileSystemKeyStore extends KeyStore {
    /** @hidden */
...
export { UnencryptedFileSystemKeyStore, readKeyFile };
