import { NodeStatusResult, FinalityReference, AccessKeyView, AccessKeyList, BlockReference, AccountView, ContractCodeView, ContractStateView, SerializedReturnValue, CallContractViewFunctionResultRaw, BlockResult, ChunkId, ChunkResult, BlockId, GasPrice, EpochValidatorInfo, TxExecutionStatus, FinalExecutionOutcome, ExecutionOutcomeReceiptDetail, QueryResponseKind, RpcQueryRequest, BlockChangeResult, NearProtocolConfig, LightClientProofRequest, LightClientProof, NextLightClientBlockRequest, NextLightClientBlockResponse, ChangeResult, AccessKeyWithPublicKey } from '@near-js/types';
 ...
 */
declare class FailoverRpcProvider implements Provider {
    /** @hidden */
    ...
    viewAccessKey(accountId: string, publicKey: PublicKey, finalityQuery?: FinalityReference): Promise<AccessKeyView>;
    ...
    viewContractCode(accountId: string, blockQuery?: BlockReference): Promise<ContractCodeView>;
    viewContractState(accountId: string, prefix?: string, blockQuery?: BlockReference): Promise<ContractStateView>;
    callFunction<T extends SerializedReturnValue>(accountId: string, method: string, args: Record<string, unknown>, blockQuery?: BlockReference): Promise<T>;
    callFunctionRaw(accountId: string, method: string, args: Record<string, unknown>, blockQuery?: BlockReference): Promise<CallContractViewFunctionResultRaw>;
