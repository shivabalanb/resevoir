import { FinalityReference, AccessKeyView, AccessKeyList, BlockReference, AccountView, ContractCodeView, ContractStateView, SerializedReturnValue, CallContractViewFunctionResultRaw, BlockResult, ChunkId, ChunkResult, BlockId, GasPrice, NodeStatusResult, EpochValidatorInfo, TxExecutionStatus, FinalExecutionOutcome, ExecutionOutcomeReceiptDetail, QueryResponseKind, BlockChangeResult, NearProtocolConfig, LightClientProofRequest, LightClientProof, NextLightClientBlockRequest, NextLightClientBlockResponse, ChangeResult, AccessKeyWithPublicKey } from '@near-js/types';
import { SignedTransaction } from '@near-js/transactions';
import { Provider } from './provider.cjs';
import { ConnectionInfo } from './fetch_json.cjs';
 ...
 */
declare class JsonRpcProvider implements Provider {
    /** @hidden */
